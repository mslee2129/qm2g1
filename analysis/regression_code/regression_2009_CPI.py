...
for country in country_list:
    ...
    protests_country = protests_country[protests_country.year >= 2009]
    # print(protests_country)
    ...
    sn.regplot(x="protests", y="CPI_Score", data=df, scatter=True, fit_reg=True)
    plt.title(country + ' Protests vs CPI Score since 2010')
    plt.grid(True)
    plt.savefig(country + '_corruption_regression_2009.png')
    plt.show()
...
# print(r2_list)
# print(p_list)
fig = go.Figure(data=[go.Table(header=dict(values=['Country', 'Coefficient 2009', 'Intercept 2009', 'p-values 2009', 'r2 values 2009',]),
